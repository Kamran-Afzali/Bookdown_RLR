...
if (first_success < n_episodes && random_first_success < n_episodes) {
...
cat(sprintf("Curiosity agent: %.2f\n", curiosity_final_success))
cat(sprintf("Random agent: %.2f\n", random_final_success))
```
